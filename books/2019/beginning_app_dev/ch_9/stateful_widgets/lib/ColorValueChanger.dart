...
class ColorValueChanger extends StatefulWidget {
  ...
  ColorValueChanger(
      {Key key, this.property = "property", this.value = 0, this.onChanged})
      : super(key: key);
...
class _ColorValueChangerState extends State<ColorValueChanger> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      child: Column(
        children: <Widget>[
          Text(widget.property, style: Theme.of(context).textTheme.subtitle2),
          Slider(
            min: 0,
            max: 255,
  ...
  _onChanged(double value) {
    setState(() => this._value = value.round());
