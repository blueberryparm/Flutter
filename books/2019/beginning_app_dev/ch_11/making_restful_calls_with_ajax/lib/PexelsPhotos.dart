...
import 'sensitiveConstants.dart'
    show
        pexelsApiKey; // Remember, you'll need to put your own API key in a file called sensitiveConstants.dart to make this work for you.
            ...
            child: FutureBuilder<Response>(
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                ...
                final List<Photo> photos =
                    photosDynamic.map<Photo>((dynamic p) {
